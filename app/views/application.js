...
export default View.extend({
  setupFoundation: on('didInsertElement', function() {
    ...
    //   Ember.$('.has-dropdown.not-click a').click(function() {
    //     Ember.$('.has-dropdown.not-click').removeClass('hover');
    //   });

    //   Ember.$('.has-dropdown.not-click').hover(
    //     function() {
    //       $(this).addClass('hover');
    //     },
    //     function() {
    ...
    Ember.$('.top-bar').click(function() {
      Ember.$('.top-bar, [data-topbar]').css('height', '').removeClass('expanded');
    });
